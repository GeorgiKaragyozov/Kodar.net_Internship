...
namespace UniversityDemo.Presentation.Service.DisciplineStatus
{
    ...
    {
        public IDisciplineStatusProcessor Processor = new DisciplineStatusProcessor();

        //public DisciplineStatusService(IDisciplineStatusProcessor processor)
        //{
        ...
        public ApiResponse ListAll()
        {
            ...
            try
            {
                List<DisciplineStatusResult> results = Processor.Find();
