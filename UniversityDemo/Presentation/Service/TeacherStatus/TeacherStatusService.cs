...
namespace UniversityDemo.Presentation.Service.TeacherStatus
{
    ...
    {
        public ITeacherStatusProcessor Processor = new TeacherStatusProcessor();

        //public TeacherStatusService(ITeacherStatusProcessor processor)
        //{
        ...
        public ApiResponse ListAll()
        {
            ...
            try
            {
                List<TeacherStatusResult> results = Processor.Find();
