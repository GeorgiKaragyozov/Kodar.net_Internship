...
namespace UniversityDemo.Presentation.Service.FacultyStatus
{
    ...
    {
        public IFacultyStatusProcessor Processor = new FacultyStatusProcessor();

        //public FacultyStatusService(IFacultyStatusProcessor processor)
        //{
        ...
        public ApiResponse ListAll()
        {
            ...
            try
            {
                List<FacultyStatusResult> results = Processor.Find();
