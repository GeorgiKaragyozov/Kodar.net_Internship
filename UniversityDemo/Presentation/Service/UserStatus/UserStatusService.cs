...
namespace UniversityDemo.Presentation.Service.UserStatus
{
    ...
    {
        public IUserStatusProcessor Processor = new UserStatusProcessor();

        //public UserStatusService(IUserStatusProcessor processor)
        //{
        ...
        public ApiResponse ListAll()
        {
            ...
            try
            {
                List<UserStatusResult> results = Processor.Find();
